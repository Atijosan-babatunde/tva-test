import styles from '../../Dashboard/createTask/css/createtask.module.css'
...
const CreateTask = () => {
    ...
    const validate = () => {
        return(
            !calendar || !calendarDue || !project || !description || dropDownValue === 'Select' || dropDownValueAssign === "Select" || dropDownValuePosition === "Select"
        )
    }
        ...
        <div className={styles.parent}>
            <div className={styles.content}>
                <div className={styles.contentbtn}>
                    <div className={styles.contenth2}>Create Task</div>
